...
export class HomePage implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.profile = {
            name: '김근영',
            birth_format: '1993-03-04',
            sl: 'S',
        };
        this.mainUser = {
            zodiac: '닭'
        };
        this.mainZodiac = '천천히 여유를 가지고 살자. 뒤쳐지는 것처럼 보일지 몰라도 시간이 지나면 남들보다 앞서 간다. 오늘은 휴식을 취하는 것이 좋다. 더위가 시작된다. 힘 빼지 말고 천천히 가자.'
        this.mainViewData = '천천히 여유를 가지고 살자. 뒤쳐지는 것처럼 보일지 몰라도 시간이 지나면 남들보다 앞서 간다. 오늘은 휴식을 취하는 것이 좋다. 더위가 시작된다. 힘 빼지 말고 천천히 가자.'
